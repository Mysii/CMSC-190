...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li class="active"><a href="sendnotif.html"><svg class="glyph stroked email"><use xlink:href="#stroked-email"/></svg> Send  Notification</a></li>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Send Notifications</h1>
			</div>
		</div><!--/.row-->
