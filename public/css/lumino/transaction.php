...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li class="active"><a href="transaction.html"><svg class="glyph stroked app window with content"><use xlink:href="#stroked-app-window-with-content"/></svg></use></svg> Transaction</a></li>
			...
			<li><a href="sales.html"><svg class="glyph stroked line-graph"><use xlink:href="#stroked-line-graph"></use></svg> Sales</a></li>
									...
									<div class="panel panel-default">
										<div class="panel-body">
											<table data-toggle="table" data-url="" >
											    <thead>
											    <tr>
											        <th data-field="id" data-align="">Transaction Code</th>
											        <th data-field="">Client Name</th>
											        <th data-field="id">Transaction Type</th>
											        <th data-field="">Unit</th>
											        <th data-field="">Serial No.</th>
											        <th data-field="">Principal Loan</th>
											        <th data-field="">"Tubos"</th>
											        <th data-field="">Staff</th>
											    </tr>
											    </thead>
											</table>
										</div>
