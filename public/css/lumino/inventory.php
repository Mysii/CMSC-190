...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li class="active"><a href="inventory.html"><svg class="glyph stroked clipboard with paper"><use xlink:href="#stroked-clipboard-with-paper"/></svg> Inventory</a></li>
				...
				<div class="panel panel-default">
					<div class="panel-body tabs">
						<ul class="nav nav-tabs">
							...
							<li><a href="#tab3" data-toggle="tab">Redeemed</a></li>
							<li><a href="#tab3" data-toggle="tab">Acquired</a></li>
							<li><a href="#tab3" data-toggle="tab">With Penalty</a></li>
						</ul>
									...
									<div class="panel panel-default">
										<div class="panel-body">
											<table data-toggle="table" data-url="" >
											    <thead>
											    <tr>
											        <th data-field="id" data-align="">Inventory ID</th>
											        <th data-field="name">Item No.</th>
