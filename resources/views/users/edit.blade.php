			...
			<div class="col-md-8 col-md-offset-2">
				<div class="panel panel-default">
					<div class="panel-heading">
						Edit User Info <small><a href="/users">[Back to List]</a></small>
					</div>
					...
					<div class="panel-body">
						<form class="form-horizontal" role="form" method="POST" action="/users/{{ $user->id }}">
							...
							<div class="form-group{{ $errors->has('contactNo') ? ' has-error' : '' }}">
								...
								<div class="col-md-6">
									<input id="contactNo" type="text" class="form-control" name="contactNo" value="{{ $user->contactNo }}" required autofocus>
							...
							<div class="form-group{{ $errors->has('isAdmin') ? ' has-error' : '' }}">
								...
								<div class="col-md-6">
									<input id="isAdmin" type="text" class="form-control" name="isAdmin" value="{{ $user->isAdmin }}" required autofocus>
