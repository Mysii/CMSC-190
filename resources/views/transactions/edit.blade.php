			...
			<div class="col-md-8 col-md-offset-2">
				<div class="panel panel-default">
					<div class="panel-heading">
						Edit Transaction <small><a href="/transactions">[Back to Records]</a></small>
					</div>

					<div class="panel-body">
						<form class="form-horizontal" role="form" method="POST" action="/transactions/{{ $transaction->id }}">
							{{ method_field('PUT') }}
							{{ csrf_field() }}
							...
							<div class="form-group{{ $errors->has('branch') ? ' has-error' : '' }}">
								...
								<div class="col-md-6">
									<select id="branch" type="" class="form-control" name="branch" value="" required autofocus>
										<option>{{ $transaction->branch }}</option>
										<!-- Muntinlupa Branches -->
							...
							<div class="form-group{{ $errors->has('transactionCode') ? ' has-error' : '' }}">
								...
								<div class="col-md-6">
									<input id="transactionCode" type="text" class="form-control" name="transactionCode" value="{{ $transaction->transactionCode }}" required autofocus >
							...
							<div class="form-group{{ $errors->has('transactionType') ? ' has-error' : '' }}">
								...
								<div class="col-md-6">
									<select id="transactionType" type="" class="form-control" name="transactionType" value="" required autofocus>
							...
							<div class="form-group{{ $errors->has('clientName') ? ' has-error' : '' }}">
								...
								<div class="col-md-6">
									<input id="clientName" type="text" class="form-control" name="clientName" value="{{ $transaction->clientName }}" required autofocus>
							...
							<div class="form-group{{ $errors->has('contactNo') ? ' has-error' : '' }}">
								...
								<div class="col-md-6">
									<input id="contactNo" type="text" class="form-control" name="contactNo" value="{{ $transaction->contactNo }}" required autofocus>
							...
							<div class="form-group{{ $errors->has('unit') ? ' has-error' : '' }}">
								...
								<div class="col-md-6">
									<input id="unit" type="text" class="form-control" name="unit" value="{{ $transaction->unit }}" required autofocus>
							...
							<div class="form-group{{ $errors->has('serialNo') ? ' has-error' : '' }}">
								...
								<div class="col-md-6">
									<input id="serialNo" type="text" class="form-control" name="serialNo" value="{{ $transaction->serialNo }}" required autofocus>
							...
							<div class="form-group{{ $errors->has('principalLoan') ? ' has-error' : '' }}">
								...
								<div class="col-md-6">
									<input onChange="calculateTubos()" id="principalLoan" type="number" class="form-control" name="principalLoan" value="{{ $transaction->principalLoan }}" required autofocus>
							...
							<div class="form-group{{ $errors->has('tubos') ? ' has-error' : '' }}">
								...
								<div class="col-md-6">
									<input id="tubos" type="number" class="form-control" name="tubos" value="{{ $transaction->tubos }}" required autofocus>
							...
							<div class="form-group{{ $errors->has('penalty') ? ' has-error' : '' }}">
								...
								<div class="col-md-6">
									<input id="penalty" type="number" class="form-control" name="penalty" value="{{ $transaction->penalty }}"  autofocus>
							...
							<div class="form-group{{ $errors->has('date') ? ' has-error' : '' }}">
								...
								<div class="col-md-6">
									<input onChange="calculateDueDate()" id="date" type="date" class="form-control" name="date" value="{{ $transaction->date }}" required autofocus>
							...
							<div class="form-group{{ $errors->has('dueDate') ? ' has-error' : '' }}">
								...
								<div class="col-md-6">
									<input id="dueDate" type="text" class="form-control" name="dueDate" value="{{ $transaction->dueDate }}" required autofocus>
							...
							<div class="form-group{{ $errors->has('staffAssigned') ? ' has-error' : '' }}">
								...
								<div class="col-md-6">
									<input id="staffAssigned" type="text" class="form-control" name="staffAssigned" value="{{ $transaction->staffAssigned }}" required autofocus>
