  ...
  <body>
          ...
          <div class="container">
            ...
            <div id="navbar" class="navbar-collapse collapse">
              <ul class="nav navbar-nav">
                <li class="active"><a href="href="{{ url('/') }}">Home</a></li>
    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox">
        ...
        <div class="item">
          <img class="second-slide" src="/images/image3.jpg" alt="Second slide">
          <div class="container">
            <div class="carousel-caption">
        ...
        <div class="item">
          <img class="third-slide" src="/images/image1.jpg" alt="Third slide">
          <div class="container">
            <div class="carousel-caption">
    ...
    <div class="container marketing">
      ...
      <footer>
        ...
        <p>&copy; 2017 J & M Pawnshop &middot; <a href="#">Privacy</a> &middot; <a href="#">Terms</a></p>
      </footer>
    ...
    <script>window.jQuery || document.write('<script src="/css/bootstrap-3.3.7/docs/assets/js/vendorjquery.min.js"><\/script>')</script>
